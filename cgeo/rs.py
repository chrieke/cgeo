...
class Sensors(object):
    ...
    def __init__(self, sensor: str=None):
        ...
        sensor_bands = {'S2': {1: 'coastal', 2: 'blue', 3: 'green', 4: 'red', 5: 'rededge1', 6: 'rededge2',
                               7: 'rededge3', 8: 'nir', 9: 'watervapour', 10: 'cirrus', 11: 'swir1', 12: 'swir2'},
                        'L8': {},
                        'S1': {'VH', 'VV'}
                        }
        self.sensor_bands = sensor_bands

        band_combinations = {'S2': {'RGB': [4, 3, 2]},
                             'L8': {},
                             'S1': {}
                             }
